export function getWrapperContract(chainId: number | undefined) {
  // Goerli
  if (chainId === 5) {
    return {
      abi,
      address: '0x114D4603199df73e7D157787f8778E21fCd13066' as `0x${string}`,
    }
  }
  ...
  return {
    abi,
    address: '0xD4416b13d2b3a9aBae7AcD5D6C2BbDBE25686401' as `0x${string}`,
  }
}
