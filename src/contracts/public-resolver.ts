export function getPublicResolverContract(chainId: number | undefined) {
  // Goerli
  if (chainId === 5) {
    return {
      abi,
      address: '0xd7a4F6473f32aC2Af804B3686AE8F1932bC35750' as `0x${string}`,
    }
  }
  ...
  return {
    abi,
    address: '0x231b0Ee14048e9dCcD1d247744d114a4EB5E8E63' as `0x${string}`,
  }
}
